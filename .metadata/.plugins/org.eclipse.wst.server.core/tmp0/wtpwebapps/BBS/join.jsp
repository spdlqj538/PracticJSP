...
<body>
	...
	<section class="w-[80%] h-[600px]">
		<h2 class="text-center text-2xl leading-[150px]">회원가입 폼</h2>
		<div class="w-full max-w-xs">
	  		<form method="post" action="joinAction.jsp" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
	    		<div class="mb-4">
	    		...
	    		<div class="mb-4">
	      			...
	      			<input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="userName" id="username" type="text" placeholder="이름">
	    		</div>
	    		<div class="mb-4">
	    			<label class="block text-gray-700 text-sm font-bold mb-2 float-left mr-[20px]" for="username">남자
	    				<input class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" name="userGender" autocomplete="off" type="radio" value="남자">
	    			</label>
	    			<label class="block text-gray-700 text-sm font-bold mb-2" for="username">여자
	    				<input class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" name="userGender" autocomplete="off" type="radio" value="여자">
	    			</label>
	    		</div>
	    		<div class="mb-6">
	      			<label class="block text-gray-700 text-sm font-bold mb-2" for="username">이메일</label>
	      			<input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="userEmail" id="username" type="email" placeholder="이메일">
	    		</div>
	    		<div class="flex items-center justify-between">
	      			<input class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit" value="회원가입">
	    		</div>
	  		</form>
		</div>
	</section>	
